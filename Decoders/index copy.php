                ...
                <p>
                    ...
                    <?php
                        ...
                        switch ( $selected_val  ) {
                            case "0": // JSON
                                $sf = ' -of json 2>&1';
                                echo( "Decoded frame (json) : " . htmlspecialchars($user_statement, ENT_QUOTES) );
                            break;
                            case "1": // XMLP
                                $sf =' -of xmlp 2>&1';
                                echo( "Decoded frame (xmlp) : " . htmlspecialchars($user_statement, ENT_QUOTES) );
                            break;
                            case "2": // XMLL
                                $sf =' -of xmll 2>&1';
                                echo( "Decoded frame (xmll) : " . htmlspecialchars($user_statement, ENT_QUOTES) );
                            break;
                            case "3": // STD
                                $sf = ' -of std 2>&1';
                                echo( "Decoded frame (std) : " . htmlspecialchars($user_statement, ENT_QUOTES) );
                            break;
                            case "4": // JSON-VERIF
                                $sf = ' -of json-verif 2>&1';
                                echo( "Decoded frame (json-verif) : " . htmlspecialchars($user_statement, ENT_QUOTES) );
                            break;
                        }
        ...
        <DIV class="wtc-panel">
            ...
            <form method="get" action="" name="statement_user2" onsubmit="return doBeforeSubmit()">
                ...
                <?php
                    ...
                    echo( "<br>");
                    echo( "TimeStamp: " . htmlspecialchars($user_statement_timestamp, ENT_QUOTES) );
                    echo( "<br>");
                    echo( "Batch attributes: " . htmlspecialchars($user_statement_attributes, ENT_QUOTES) );
